...
import { DivColumn, FooterSubtitle, FooterTitle, FooterWrapper, ItemName, ItemSelect, ItemWrapper, MenuWrapper, SettingButton, SquarePhoto, Subtitle, Title, TitleWrapper, UserEmail, UserName, UserWrapper } from '../styles/menu-StyledComp'
import { Div, Nav, NavWrapper } from '../styles/navbar-StyledComp'
          ...
          {isVisible
            ? <MenuWrapper $isOpen={isVisible}>
                ...
                <UserWrapper>
                    ...
                    <SettingButton> <IoMdSettings /> </SettingButton>
                </UserWrapper>
                <FooterWrapper>
